...
export default function StoresPage() {
    return (
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-12 md:py-16 pb-24 space-y-12">
            ...
            >
                <span className="text-accent font-black tracking-[0.3em] text-xs uppercase">Locations</span>
            ...
            <div className="grid md:grid-cols-3 gap-4">
                {[
                    ...
                    <motion.div
                        ...
                        className="bg-white dark:bg-slate-900 border border-primary/5 dark:border-slate-800 rounded-2xl p-6 space-y-3"
                    >
                        <div className="w-10 h-10 rounded-xl bg-accent/10 text-accent flex items-center justify-center">
                            <card.icon className="w-5 h-5" />
                        </div>
                        <h3 className="font-black text-primary dark:text-white tracking-tight">{card.title}</h3>
            ...
            >
                <h2 className="text-2xl md:text-3xl font-black tracking-tight">Have a question about delivery?</h2>
