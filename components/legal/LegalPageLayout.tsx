...
export default function LegalPageLayout({ eyebrow, title, lastUpdated, children }: LegalPageLayoutProps) {
    return (
        <div className="bg-white dark:bg-slate-950 min-h-screen">
            {/* Header banner */}
            <section className="bg-gray-50 dark:bg-slate-900/40 border-b border-primary/5 dark:border-slate-800 py-14 md:py-20">
                <div className="max-w-3xl mx-auto px-4 md:px-8 text-center space-y-4">
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-6xl font-black text-primary dark:text-white tracking-tighter leading-[1.1]"
                    >
                        {title}
                    </motion.h1>
