...
import { X, ChevronRight, ShoppingBag, Heart, User, Search, Home, Grid, Tag, Mail, HelpCircle, BookOpen } from 'lucide-react';
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-0 left-0 h-full w-[300px] sm:w-[400px] bg-white dark:bg-ink-950 z-[70] shadow-2xl overflow-y-auto"
                    >
                        <div className="p-8 h-full flex flex-col">
                            {/* Header */}
                            <div className="flex items-center justify-between mb-12">
                                <Link href="/" onClick={onClose} className="text-3xl font-medium tracking-tight text-primary dark:text-white">
                                    LuxeCart
                                </Link>
                                <button
                                    onClick={onClose}
                                ...
                                {menuItems.map((item) => (
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-gray-50 dark:bg-ink-900 flex items-center justify-center group-hover:bg-white dark:group-hover:bg-slate-800 transition-colors shadow-sm">
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-100 dark:border-slate-900">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-gray-50 dark:bg-ink-900 border-none rounded-xl py-4 pl-12 pr-4 text-sm font-medium outline-none focus:ring-2 ring-primary/10 dark:ring-white/10 dark:text-white"
                                    />
                                </div>
                            </div>
                        </div>
